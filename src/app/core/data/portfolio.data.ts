...
export const PORTFOLIO_DATA: PortfolioData = {
  ...
  education: [
    ...
    },
    {
      ...
      certificateUrl:
        'https://verify.skilljar.com/c/x5v96z5irfqk',
  ...
  portfolio: [
    ...
    },
    {
      ...
      modalBody:
        '# Problem\nIBM Research\'s Ponder This publishes a monthly math/CS challenge typically requiring a mix of algorithmic insight and computational search. Topics spanned graph theory, max-flow optimization, combinatorial enumeration, knapsack problem and number theory.\n\n# Approach\nI solved each problem in VBA, Python or C# depending on the problem shape — smaller search spaces with rich structure went to VBA prototypes, larger combinatorial searches to Python or C# with optimized representations.\n- Jan 2021 — Modular grid traversal with state-dependent rotation (Vaccinating Robot)\n- Feb 2021 — Minimum vertex set on a trust-dependency graph via strongly connected components (Vaccination Ring)\n- Mar 2021 — Closure problem on a 20×20 grid solved via max-flow (Perseverance Rover)\n- Apr 2021 — Combinatorial enumeration of unwinnable sets (Decremental Wheel of Choice)\n- Dec 2021 — Deterministic pin orientation optimization (Galton Board)\n- Jan 2022 — Prime-forming graph traversal on a digit circle (Forming Primes)\n- Jun 2026 — Minimal Combinations to cover all possible sets (The Superhero Team Movies)\n- Jul 2026 — Knapsack problem (The Superhero villain combinations)\n\n# Impact\nEarned the bonus star on 7 of 8 challenges. All solver names are verified on IBM Research\'s public archive.',
      links: [
        ...
        { label: 'July 2026 - Return of the Superheroes', url: 'https://research.ibm.com/blog/ponder-this-july-2026' },
      ],
